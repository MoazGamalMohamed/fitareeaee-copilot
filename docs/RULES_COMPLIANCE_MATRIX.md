...
| Request versus Offer | Rider/sender accounts create **Requests** and are the paying side. Driver/courier accounts create **Offers**, require driver and vehicle verification, and are the receiving side. The server enforces the path chosen at sign-up. |
